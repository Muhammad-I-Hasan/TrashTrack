...
import BatteryImage from "/src/images/Battery.png";
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography variant="body2" sx={{ marginBottom: "6px" }}>
              Batteries should be taken to a designed drop off site to dispose of them properly.
            </Typography>
            <Typography variant="body2">
              <strong>Decomposition Time:</strong> ~100 years
            </Typography>
          </Box>
        </Box>
      </div>
